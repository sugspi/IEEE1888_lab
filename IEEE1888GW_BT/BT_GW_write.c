...
const char *POINT_SET = "http://www.gutp.jp/v2/bt/";
...
int loadCSV()
{
	...
	fscanf(fp,"%[^,],%[^,],%[^,],%[^,],%[^,],%[^,],%[^,],%[^,],%[^,],%[^,],%[^,],%[^,]",
			...
			mydata[10].value,mydata[11].value);

	printf("%s %s %s %s %s %s %s %s %s %s %s %s\n",
		mydata[0].value,mydata[1].value,mydata[2].value,mydata[3].value,mydata[4].value,
		mydata[5].value,mydata[6].value,mydata[7].value,mydata[8].value,mydata[9].value,mydata[10].value,mydata[11].value);
...
int main(int argc, char** argv){
	...
	while(1){
		...
		strcat(mydata[0].id,"vbt");
		strcat(mydata[1].id,"ibt");
		strcat(mydata[2].id,"pbt");
		strcat(mydata[3].id,"qbt");
		strcat(mydata[4].id,"whbt");
		strcat(mydata[5].id,"fbt");
		strcat(mydata[6].id,"pfbt");
		strcat(mydata[7].id,"vbdc");
		strcat(mydata[8].id,"ibdc");
		strcat(mydata[9].id,"pbdc");
		strcat(mydata[10].id,"efbdc");
		strcat(mydata[11].id,"efbc");
		...
		ps -> id = ieee1888_mk_uri("http://www.gutp.jp/v2/bt/");
