...
for($t=24; $t>0; $t--){
  ...
  if($t>18)
  {
    ...
    $start = "2015-11-10T$box1:00:09+00:00";
    $end = "2015-11-10T$box2:00:09+00:00";
    ...
    if($t>8){
      $start = "2015-11-10T0$box1:00:09+00:00";
    }else{
      $start = "2015-11-10T$box1:00:09+00:00";
    }

    if($t>9){
      $end = "2015-11-10T0$box2:00:09+00:00";
    }else{
      $end = "2015-11-10T$box2:00:09+00:00";
    }
  }
  ...
  if($t==19){
    $start = "2015-11-09T23:00:09+00:00";
    $end = "2015-11-10T00:00:09+00:00";
  }
